...
\lstset{
        ...
        tabsize=4,
        frame = ,
        morekeywords={result, action, do, data, extern, request, class, new, module,import,where,let,case,if,then,else,elsif,forall, struct, private},
        morekeywords=[2]{},
        morekeywords=[3]{},
...
\bibitem{kero1} Martin Kero, Johan Nordlander, and Per Lindgren \emph{A Correct and Useful Incremental Copying Garbage Collector. In IEEE International Symposium on Memory Management (ISMM)}, Montreal, QB,  2007.
\bibitem{kero2} Martin Kero, \emph{Garbage Collection for Reactive Real-Time Systems}, Doctoral thesis, Lule{\aa} University of Technology, October 2010.
